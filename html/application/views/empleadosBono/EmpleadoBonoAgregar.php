					...
					<div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
						...
						<form id="FrmEmpleadosBono" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper text-uppercase" id="empleadoEmpleadoBono" name="empleadoEmpleadoBono" placeholder="Nombre completo" readonly>
										</div>
									</div>
									<input type="hidden" id="idEmpleadoEmpleadoBono" name="idEmpleadoEmpleadoBono" value="">                               								
								</div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label for="montoEmpleadoBono">Monto <span class="text-danger">*</span></label>
											<input type="text" class="form-control decimal" id="montoEmpleadoBono" name="montoEmpleadoBono" placeholder="0.00" >
										</div>
									</div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											...
											<select class="form-control" id="idPeriodoEmpleadoBono" name="idPeriodoEmpleadoBono" >
                                                ...
                                                <option value="<?=$idPeriodoPlanilla; ?>" <?=($idPeriodoPlanilla == "" ? 'disabled' : ''); ?>>PERIODO ACTUAL</option>
                                                <option value="<?=(int)$idPeriodoPlanilla+1; ?>" <?=($idPeriodoPlanilla == "" ? 'disabled' : ''); ?>>PERIODO SIGUIENTE</option>
                                            </select>
										</div>
									</div>                                    								
								</div>
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="descripcionEmpleadoBono" name="descripcionEmpleadoBono"></textarea>
										</div>
									</div>                                   								
								</div>
							</div>
							...
							<div class="card-footer">
								<input type="hidden" name="idEmpleadoBono" id="idEmpleadoBono" value="0">
