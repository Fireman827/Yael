...
<div class="modal-body">
	<div class="row">
        ...
        <select name="idClienteMembrecia" id="idClienteMembrecia" class="form-control select2">
    ...
    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="codigoMembrecia" name="codigoMembrecia" value="<?= $pin; ?>" readonly>
      </div>
    </div>
	</div>
</div>
<div class="modal-footer">
  <input type="hidden" name="proceso" id="proceso" value="Insertar">
