					...
					<div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
						...
						<form id="FrmCaja" autocomplete="off">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="nombreCaja">Nombre <span class="text-danger">*</span></label>
											<input type="text" class="form-control upper text-uppercase" id="nombreCaja" name="nombreCaja" placeholder="Nombre de la caja">
										</div>
									</div>                                  								
								...
								<div class="row mt-1">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="table-responsive" style="height: 245px;">
											<table class="table table-sm table-condensed float rounded" id="tablaCajaDocumento">
												<thead class="bg-<?= GblTraerConfiguracion('colorComponentes'); ?>">
													<tr class="text-center">
														<th colspan="9">Documentos de Caja
															<button type="button" class="float-right btn btn-sm btn-<?= GblTraerConfiguracion('colorComponentes'); ?> agregarCajaDocumento" id_btn='agregar_nuevo'><i class="fa fa-plus"></i></button>
														</th>
													</tr>
													<tr>
														...
														<th class="col-1">Número de Resolución</th>														
							...
							<div class="card-footer">
								<input type="hidden" name="idCaja" id="idCaja" value="0">
