								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper" id="nombreCliente" name="nombreCliente" placeholder="Nombre del Cliente">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="nombreCliente">Dirección</label>
											<input type="text" class="form-control upper" id="direccionCliente" name="direccionCliente" placeholder="Dirección del Cliente">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label for="ClienteCliente">Teléfono</label>
											<input type="text" class="form-control tel" id="telefonoCliente" name="telefonoCliente" placeholder="Teléfono">
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label for="claveCliente">Punto de Referencia</label>
											<input type="text" class="form-control" id="referenciaCliente" name="referenciaCliente" placeholder="Punto de Referencia">
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label for="idCategoriaCliente">Categoría del Cliente</label>
											<select type="text" class="form-control select2" id="idCategoriaCliente" name="idCategoriaCliente">
