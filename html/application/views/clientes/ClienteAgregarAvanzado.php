								...
								<div class="row">
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper text-uppercase" id="nombreCliente" name="nombreCliente" placeholder="Nombre del Cliente">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="nombreCliente">Dirección</label>
											<input type="text" class="form-control upper text-uppercase" id="direccionCliente" name="direccionCliente" placeholder="Dirección del Cliente">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="telefonoCliente">Teléfono</label>
											<input type="text" class="form-control tel" id="telefonoCliente" name="telefonoCliente" placeholder="Teléfono">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="emailCliente">Correo</label>
											<input type="text" class="form-control" id="emailCliente" name="emailCliente" placeholder="correo@servidor.com">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control dui" id="duiCliente" name="duiCliente" placeholder="000000-0">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control nit" id="nitCliente" name="nitCliente" placeholder="0000-000000-000-0">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="claveCliente">NRC</label>
											<input type="text" class="form-control" id="nrcCliente" name="nrcCliente" placeholder="000000-0">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper text-uppercase" id="referenciaCliente" name="referenciaCliente" placeholder="Referencia">
										</div>
									</div>
