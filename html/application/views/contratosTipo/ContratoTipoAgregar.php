            ...
            <form id="FrmContratos" autocomplete="off">
              <div class="card-body">
                <div class="row">
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nombreContratoTipo" id="nombreContratoTipo" class="form-control upper text-uppercase" placeholder="Nombre del tipo de contrato">
                    </div>
                  </div>
                ...
                <!-- <div class="row" hidden>
                  <div class="col">
                    <input type="hidden" name="idContratoTipo" id="idContratoTipo" value="">
                  </div>
                </div> -->
              </div>
              <!-- /.card-body -->
              <div class="card-footer">
                <input type="hidden" name="idContratoTipo" id="idContratoTipo" value="0">
