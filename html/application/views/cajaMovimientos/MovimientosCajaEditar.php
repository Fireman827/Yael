		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="entregaMovimiento" id="entregaMovimiento" class="form-control upper text-uppercase" value="<?php echo $datosMovimiento->entregaCajaMovimiento; ?>" placeholder="Entrega">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="recibeMovimiento" id="recibeMovimiento" class="form-control upper text-uppercase" value="<?php echo $datosMovimiento->recibeCajaMovimiento; ?>" placeholder="Recibe">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="montoIngreso" id="montoIngreso" class="form-control upper text-uppercase decimal" value="<?php echo $datosMovimiento->montoCajaMovimiento; ?>" placeholder="Monto de la salida">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<textarea name="conceptoIngreso" id="conceptoIngreso" class="form-control upper text-uppercase"><?php echo $datosMovimiento->conceptoCajaMovimiento; ?></textarea>
				</div>
			</div>
		</div>
    <input type="hidden" value="<?=$idCorteCaja; ?>" id="idCorteCaja" name="idCorteCaja">
    <input type="hidden" value="<?=$idCajaMovimiento; ?>" id="idCajaMovimiento" name="idCajaMovimiento">
...
<?php if (isset($proceso)) { ?>
	<input type="hidden" value="Editar" id="proceso">
<?php } ?>
<!-- /.modal-content -->
