								...
								<div class="row">
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<div class="form-group">
											...
											<input type="text" class="form-control numeric" id="tiempoServicio" name="tiempoServicio" placeholder="tiempo de la Servicio">
										</div>
									</div>
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<div class="form-group">
											...
											<select id="categoriaServicio" name="categoriaServicio" class="select2 col-12">
												...
												<?php if ($categorias !== false) : ?>
													<?php foreach ($categorias as $categoria) : ?>
														<option value="<?= $categoria->idServicioCategoria ?>"><?= $categoria->nombreServicioCategoria; ?></option>
													<?php endforeach; ?>
												<?php endif; ?>
											</select>
										</div>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											...
											<textarea class="form-control upper" name="descripcionServicio" id="descripcionServicio" rows="2"></textarea>
										</div>
									</div>
								</div>
								<div class="row">
													...
													<?php if ($senoritas !== false) : ?>
														<?php foreach ($senoritas as $senorita) : ?>
															<tr>
																...
																<td><input type="text" class="form-control montoTotal decimal" value="" required="required" pattern="" title="" placeholder="$ 0000.00"></td>
																<td><input type="text" class="form-control porcentajeSenorita decimal" value="" required="required" pattern="" title="" placeholder="000%"></td>
															</tr>
														<?php endforeach; ?>
													<?php endif; ?>
												</tbody>
