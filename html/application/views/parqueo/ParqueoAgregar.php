...
<div class="modal-body">
    ...
    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="placaParqueo" name="placaParqueo" value="">
      </div>
    </div>
    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
      <div class="form-group">
        <label for="codigoMembrecia">Hora</label>
        <input type="time" class="form-control" id="horaParqueo" name="horaParqueo" value="<?php echo date("H:i:s"); ?>">
      </div>
    </div>
	</div>
</div>
