...
<div class="modal-footer">
  <input type="hidden" name="proceso" id="proceso" value="Imprimir">
  ...
  <input type="hidden" name="horaSalidaParqueo" id="horaSalidaParqueo" value="<?= date("H:i:s");?>">
	<button type="button" class="btn btn-sm btn-<?= GblTraerConfiguracion('colorComponentes'); ?>" id="btnImprimir">Imprimir</button>
