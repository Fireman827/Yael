		...
		<div class="row">
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					...
					<input type="text" name="nombreImpresora" id="nombreImpresora" class="form-control upper text-uppercase" placeholder="Nombre de la impresora">
				</div>
			</div>
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					<label for="recursoCompartidoImpresora">Rec Comp: <span class="text-danger">*</span></label>
					<input type="text" name="recursoCompartidoImpresora" id="recursoCompartidoImpresora" class="form-control" placeholder="Nombre como recurso compartido">
				</div>
			</div>
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					<label for="IpImpresora">IP: <span class="text-danger">*</span></label>
					<input type="text" name="IpImpresora" id="IpImpresora" class="form-control ip" placeholder="IP de la impresora">
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<div class="form-group">
					...
					<input type="text" name="servidorImpresora" id="servidorImpresora" class="form-control" placeholder="Servidor de impresion">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					<div class="icheck-<?= GblTraerConfiguracion('colorComponentes'); ?> d-inline">
						<input type="checkbox" id="cobroImpresora" name="cobroImpresora" >
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					<div class="icheck-<?= GblTraerConfiguracion('colorComponentes'); ?> d-inline">
						<input type="checkbox" id="cuentaImpresora" name="cuentaImpresora">
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group">
					<div class="icheck-<?= GblTraerConfiguracion('colorComponentes'); ?> d-inline">
						<input type="checkbox" id="cocinaImpresora" name="cocinaImpresora">
