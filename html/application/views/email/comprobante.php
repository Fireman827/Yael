       ...
       <table style="width:100%">
        <tbody>
         <tr>
          <td style="border-radius:5px;background-color:#2990fe">
           <p style="text-align:center;margin:15px">
            <strong>ENVIO DE DOCUMENTO ELECTRÓNICO</strong>
           </p>
          </td>
         </tr>
         <tr>
          <td>
           ...
           <p style="margin:15px;text-align:justify">Le saludamos de <?=GblTraerConfiguracionFe('nombreComercialEmisor') ?>, adjunto enviamos Documentos Tributarios Electrónicos, el cual fue generado por su compra.</p>
         ...
         <tr style="display:none">
          <td>
           <p style="margin:15px;font-size:12px;text-align:justify">Para poder visualizar el documento tributario electronico debe tener instalado en su equipo la aplicación Adobe Acrobat Reader.</p>
          </td>
         </tr>
         <tr style="display:none">
          <td style="border-radius:5px;background-color:#2990fe">
           <p style="margin:15px;font-size:12px;text-align:justify">
