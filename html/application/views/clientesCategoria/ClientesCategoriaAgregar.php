		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="nombreClienteCategoria" id="nombreClienteCategoria" class="form-control upper text-uppercase" placeholder="Nombre de la Categoría">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="descripcionClienteCategoria" id="descripcionClienteCategoria" class="form-control upper text-uppercase" placeholder="Descripción de la Categoría">
				</div>
			</div>
		</div>
	</form>
