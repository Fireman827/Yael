							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class='form-group has-info'><label>Buscar Insumo</label>
                                            <input type="text" id="insumo_buscar" name="insumo_buscar" class="insumo_buscar form-control" placeholder="Ingrese nombre de insumo"  data-provide="typeahead">
                                            <input type="hidden" id="idInsumo" name="idInsumo">
											<label for="insumo_buscar" id="labelInsumo" class="col-sm-12 label label-<?= GblTraerConfiguracion('colorComponentes'); ?>"></label>
