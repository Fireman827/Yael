								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
										<div class="form-group">
											...
											<select class="form-control select2" name="tipoReporte" id="tipoReporte">
												
												<option value="RG">Reporte General</option>
												<option value="VE">Venta Efectivo</option>
												<option value="VT">Venta Tarjeta</option>
                                                 <option value="TR">Venta Transferencia</option>
												<option value="VB">Venta Bitcoin</option>
												<option value="VP">Venta Pedidos Ya</option>
											</select>
										</div>
									</div>
								</div>
