								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="codigoUsuario" name="codigoUsuario" placeholder="Codigo">
										</div>
									</div>
								<?php if($superAdmin == 1):?>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<div class="icheck-<?= GblTraerConfiguracion('colorComponentes'); ?> d-inline">
												<input type="checkbox" id="adminUsuario" name="adminUsuario">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<div class="icheck-<?= GblTraerConfiguracion('colorComponentes'); ?> d-inline">
												<input type="checkbox" id="autorizadoUsuario" name="autorizadoUsuario">
