		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="nombreInsumosCategoria" id="nombreInsumosCategoria" class="form-control upper text-uppercase" placeholder="Nombre de la presentación">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="text" name="descripcionInsumosCategoria" id="descripcionInsumosCategoria" class="form-control upper text-uppercase" placeholder="Nombre de la presentación">
				</div>
			</div>
		</div>
	</form>
