					...
					<div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
						...
						<form id="FrmEmpleadosDescuento" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper text-uppercase" id="empleadoEmpleadoDescuento" name="empleadoEmpleadoDescuento" placeholder="Nombre completo" readonly value="<?=$empleadoEmpleadoDescuento; ?>">
										</div>
									</div>
									<input type="hidden" id="idEmpleadoEmpleadoDescuento" name="idEmpleadoEmpleadoDescuento" value="<?=$datosEmpleadosDescuento->idEmpleadoEmpleadoDescuento; ?>">                               								
								</div>
                                <div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label for="tipoEmpleadoDescuento">Tipo <span class="text-danger">*</span></label>
											<select class="form-control" id="tipoEmpleadoDescuento" name="tipoEmpleadoDescuento" >
                                                <option value="" >Seleccione</option>
                                                <option value="DESCUENTO" <?php if($datosEmpleadosDescuento->tipoEmpleadoDescuento=="DESCUENTO") echo "selected" ?> >DESCUENTO</option>
                                                <option value="ANTICIPO" <?php if($datosEmpleadosDescuento->tipoEmpleadoDescuento=="ANTICIPO") echo "selected" ?> >ANTICIPO</option>
                                            </select>
										</div>
									</div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control decimal" id="montoEmpleadoDescuento" name="montoEmpleadoDescuento" placeholder="0.00" value="<?=$datosEmpleadosDescuento->montoEmpleadoDescuento; ?>" >
										</div>
									</div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											...
											<select class="form-control" id="idPeriodoEmpleadoDescuento" name="idPeriodoEmpleadoDescuento" >
                                                <option value="" >Seleccione</option>
                                                <option value="<?=$idPeriodoPlanilla; ?>" <?php if($datosEmpleadosDescuento->idPeriodoEmpleadoDescuento==$idPeriodoPlanilla) echo "selected"; ?> >PERIODO ACTUAL</option>
                                                <option value="<?=$idPeriodoPlanilla+1; ?>" <?php if($datosEmpleadosDescuento->idPeriodoEmpleadoDescuento==($idPeriodoPlanilla+1)) echo "selected"; ?> >PERIODO SIGUIENTE</option>
                                            </select>
										</div>
									</div>                                     								
								</div>
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="descripcionEmpleadoDescuento" name="descripcionEmpleadoDescuento"><?=$datosEmpleadosDescuento->descripcionEmpleadoDescuento; ?></textarea>
										</div>
									</div>                                   								
								</div>
							</div>
							...
							<div class="card-footer">
								<input type="hidden" name="idEmpleadoDescuento" id="idEmpleadoDescuento" value="<?=$idEmpleadoDescuento?>">
