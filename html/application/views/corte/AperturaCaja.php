					...
					<div class="input-group mb-3">
						...
						<div class="input-group-append">
							<div class="input-group-text">
								<span class="fa fa-keyboard apertura-opener"></span>
							</div>
						</div>
					</div>
				</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-sm btn-<?= GblTraerConfiguracion('colorComponentes'); ?>" id="btnApertura">Guardar</button>
