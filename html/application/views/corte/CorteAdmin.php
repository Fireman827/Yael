          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-md-2">
                  <?php if ($admin != 0) { ?>
                    <select name="cajaAperturaActual" id="cajaAperturaActual" class="form-control col-3 select2" style="width:100%">
                      <option value=""></option>
                      <?php
                      echo $cajasReal;
                      ?>
                  ...
                  <?php }else{ ?>
                    <input type="hidden" name="cajaAperturaActual" id="cajaAperturaActual" class="form-control" value="<?=$idSucursal?>">
                  <?php } ?>
                </div>
              </div>
            </div>
