								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="buscarEmpleado" name="buscarEmpleado" placeholder="buscar nombre del empleado">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="empleadoContrato">Nombre Compleado <span class="text-danger">*</span></label>
											<input type="text" class="form-control upper text-uppercase" id="empleadoContrato" name="empleadoContrato" placeholder="Nombre completo" readonly>
										</div>
									</div>
									<input type="hidden" id="idEmpleadoContrato" name="idEmpleadoContrato" value="">                               								
								</div>
                                <div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="duiContrato">DUI <span class="text-danger">*</span></label>
											<input type="text" class="form-control dui" id="duiContrato" name="duiContrato" placeholder="DUI" readonly >
										</div>
									</div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="nitContrato">NIT <span class="text-danger">*</span></label>
											<input type="text" class="form-control nit" id="nitContrato" name="nitContrato" placeholder="NIT" readonly >
										</div>
									</div>                                    								
								</div>
                                <div class="row">
                                ...
                                <div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="date" class="form-control" id="desdeContrato" name="desdeContrato">
										</div>
									</div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label for="hastaContrato">Hasta <span class="text-danger">*</span></label>
											<input type="date" class="form-control" id="hastaContrato" name="hastaContrato">
										</div>
									</div>                                    								
								</div>
                                <div class="row">
                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											...
											<textarea type="text" class="form-control upper text-uppercase" id="horarioContrato" name="horarioContrato" placeholder="Horario"></textarea>
										</div>
									</div>                                  								
								</div>
								<div class="row">
