            ...
            <div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
              ...
              <?php $fecha_actual = date("Y-m-d");?>
                <div class="card-body">
                  ...
                  <div class="row caja_compra" hidden>
                    <div class="col-md-6">
                      <div class="form-group has-info">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group has-info">
                        ...
                        <select class="form-control select2" id="tipo_documento" name='tipo_documento' style="width:100%">
                          <option value="">Seleccione</option>
                    ...
                    <div class="col-lg-3">
                      <div class='form-group has-info'>
                        ...
                        <input type='text' class='form-control' value='' id='n_documento' name='n_documento'>
                      </div>
                    </div>
                  </div>
                  <hr>
