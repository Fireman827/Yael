    ...
    <div class="row">
      <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control upper" id="categoriaSenorita" name="categoriaSenorita" value="">
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control decimal" id="cantidadComision" name="cantidadComision" value="">
        </div>
      </div>
    </div>
  </div>
