    ...
    <div class="row">
      <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control upper" id="nombreServicioCategoria" name="nombreServicioCategoria" value="">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="form-group">
          ...
          <textarea class="form-control upper" name="descripcionServicioCategoria" id="descripcionServicioCategoria" rows="3"></textarea>
        </div>
      </div>
    </div>
  </div>
