					...
					<div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
						...
						<form id="FrmEmpleadosDescuentoCuota" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control upper text-uppercase" id="empleadoEmpleadoDescuentoCuota" name="empleadoEmpleadoDescuentoCuota" placeholder="Nombre completo" readonly>
										</div>
									</div>
									<input type="hidden" id="idEmpleadoEmpleadoDescuentoCuota" name="idEmpleadoEmpleadoDescuentoCuota" value="">                               								
								</div>
                                <div class="row">
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="idInstitucionEmpleadoDescuentoCuota">Institución Financiera <span class="text-danger">*</span></label>
											<select class="form-control select2" id="idInstitucionEmpleadoDescuentoCuota" name="idInstitucionEmpleadoDescuentoCuota" style="width: 100%;" >
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control decimal" id="montoEmpleadoDescuentoCuota" name="montoEmpleadoDescuentoCuota" placeholder="0.00" >
										</div>
									</div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="numeroCuotasEmpleadoDescuentoCuota">Número de Cuotas <span class="text-danger">*</span></label>
											<input type="text" class="form-control numeric" id="numeroCuotasEmpleadoDescuentoCuota" name="numeroCuotasEmpleadoDescuentoCuota" placeholder="0" >
										</div>
									</div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="form-group">
											<label for="idPeriodoEmpleadoDescuentoCuota">Aplicado a <span class="text-danger">*</span></label>
											<select class="form-control select2" id="idPeriodoEmpleadoDescuentoCuota" name="idPeriodoEmpleadoDescuentoCuota" style="width: 100%;" >
                                                <option value="" >Seleccione</option>
                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="descripcionEmpleadoDescuentoCuota" name="descripcionEmpleadoDescuentoCuota"></textarea>
										</div>
									</div>                                   								
								</div>
							</div>
							...
							<div class="card-footer">
								<input type="hidden" name="idEmpleadoDescuentoCuota" id="idEmpleadoDescuentoCuota" value="0">
