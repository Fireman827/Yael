...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url();?>/vendors/plugins/summernote/summernote-bs4.min.css">
	  ...
	  <link rel="stylesheet" href="<?=base_url();?>/vendors/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
		...
		<link rel="stylesheet" href="<?=base_url();?>/vendors/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
		<link rel="stylesheet" href="<?=base_url();?>/vendors/plugins/TypeAhead/typeahead.css">
	  ...
	  <link rel="stylesheet" href="<?=base_url();?>/vendors/plugins/StickyTable/jquery.stickytable.css">
  ...
  <body class="hold-transition <?=GblTraerConfiguracion("modoPlantilla");?> sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
      <!-- Preloader -->
      <div class="preloader flex-column justify-content-center align-items-center">
      	<img class="animation__shake" src="<?=base_url()."/".GblTraerConfiguracion("logoEmpresa");?>" alt="dms" height="200" width="260">
      </div>
