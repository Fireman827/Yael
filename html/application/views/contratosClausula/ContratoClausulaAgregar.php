			...
			<div class="row">
				<div class="col-12">
					<div class="card card-<?=GblTraerConfiguracion('colorComponentes');?>">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form id="FrmClausula" autocomplete="off">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											<label for="nombreClausula">Nombre <span class="text-danger">*</span></label>
											<input type="text" class="form-control upper text-uppercase" id="nombreClausula" name="nombreClausula" placeholder="Nombre de la clausula">
										</div>
									</div>                                  								
								</div>
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group">
											<label for="descripcionClausula">Descripción <span class="text-danger">*</span></label>
                                            <textarea name="editor1" id="editor1" rows="10" cols="80"></textarea>
											<!-- <input type="text" class="form-control" id="descripcionClausula" name="descripcionClausula" placeholder="Descripción de la clausula"> -->
										</div>
									</div>                                  								
								</div>
							</div>
							...
							<div class="card-footer">
								<input type="hidden" name="idClausula" id="idClausula" value="0">
